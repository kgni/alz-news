...
const DashboardHeaderSkeleton = () => {
	return (
		<header className="flex gap-8 min-w-screen">
			<div className="bg-zinc-100 py-4 px-8 rounded-lg min-w-[250px] w-1/5 flex flex-col shadow-md">
				<h3 className="font-bold text-3xl mb-4">Articles</h3>
				<Skeleton containerClassName="mt-auto" height={20}></Skeleton>
			</div>
			<div className="bg-zinc-100 py-4 px-8 rounded-lg w-[300px] flex flex-col shadow-md">
				{' '}
