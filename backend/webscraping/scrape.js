...
// This can be reused for other properties than title and URL
...
function filterPuppeteerArticlesTitleAndURL(newArticles, articlesAlreadyAdded) {
...
module.exports = {
	getArticleContent,
	filterPuppeteerArticlesTitleAndURL,
};
